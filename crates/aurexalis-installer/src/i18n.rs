...
pub struct Strings {
    ...
    pub download_engine: &'static str,
    ...
    pub import_passwords: &'static str,
    pub import_passwords_hint: &'static str,
...
instala el nucleo Gecko de Aurexalis y deja el navegador listo con tema, sonidos y perfil propios.",
            install_folder: "Carpeta de instalacion",
            browse: "Examinar…",
            download_engine: "Descargar nucleo Gecko (recomendado)",
            engine_hint: "Requiere Internet. El motor se obtiene del release oficial empaquetado para Aurexalis.",
            disk_space: "Espacio libre en disco",
            next: "Siguiente",
            license_title: "Licencia y componentes de terceros",
            license_accept: "Acepto la licencia MIT de Aurexalis y entiendo que el nucleo Gecko tiene licencias de terceros",
            ...
            import_chromium: "Importar datos desde Chrome/Brave/Opera",
            import_chromium_hint: "Genera profiles\\default\\import\\chromium-audit.json en tu PC. No sube datos a Internet.",
            import_passwords: "Incluir contrasenas en la exportacion",
            import_passwords_hint: "Solo local y auditable. Requiere consentimiento explicito.",
...
installs the Aurexalis Gecko core, and prepares your themed browser profile with sounds and settings.",
            install_folder: "Install folder",
            browse: "Browse…",
            download_engine: "Download Gecko core (recommended)",
            engine_hint: "Internet required. The engine is fetched from the official release bundled for Aurexalis.",
            disk_space: "Free disk space",
            next: "Next",
            license_title: "License and third-party components",
            license_accept: "I accept the Aurexalis MIT license and understand the Gecko core has third-party licenses",
            ...
            import_chromium: "Import data from Chrome/Brave/Opera",
            import_chromium_hint: "Creates profiles\\default\\import\\chromium-audit.json locally. Nothing is uploaded.",
            import_passwords: "Include passwords in the export",
            import_passwords_hint: "Local audit file only. Requires explicit consent.",
